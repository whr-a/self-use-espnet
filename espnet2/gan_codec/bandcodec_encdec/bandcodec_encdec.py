...
class Bandcodec_encdec(AbsGANCodec):
    """DAC model."""
    ...
    def __init__(
        ...
        self.generator = Bandcodec_encdecGenerator(**generator_params)
        self.discriminator = Bandcodec_encdecDiscriminator(**discriminator_params)
...
class Bandcodec_encdecGenerator(nn.Module):
...
class Bandcodec_encdecDiscriminator(nn.Module):
